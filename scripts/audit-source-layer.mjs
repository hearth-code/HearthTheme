...
const SCHEME_CONTEXT = getSchemeContext(AUDIT_SCHEME_ID)
...
const TOP_LAYER_JSON_PATHS = [
  ...
  COLOR_SYSTEM_PRODUCT_PREVIEW_PATH,
  COLOR_SYSTEM_PRODUCT_RELEASE_PATH,
  SCHEME_CONTEXT.schemePath,
  SCHEME_CONTEXT.taxonomyPath,
  SCHEME_CONTEXT.foundationPath,
  SCHEME_CONTEXT.surfaceRulesPath,
  SCHEME_CONTEXT.guidanceRulesPath,
  SCHEME_CONTEXT.terminalRulesPath,
  SCHEME_CONTEXT.interfaceRulesPath,
  SCHEME_CONTEXT.interactionRulesPath,
  SCHEME_CONTEXT.feedbackRulesPath,
  SCHEME_CONTEXT.semanticRulesPath,
  SCHEME_CONTEXT.variantKnobsPath,
  COLOR_SYSTEM_VARIANT_PROFILES_PATH,
]
